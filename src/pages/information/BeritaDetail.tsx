  ...
  if (error || !news) {
    return (
      <div className="min-h-screen pt-24 pb-12 flex flex-col justify-center items-center">
        ...
        <Link to="/berita" className="text-emerald-500 hover:underline flex items-center gap-2">
  ...
  return (
    <div className="pt-24 pb-16 bg-slate-50 dark:bg-slate-900 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <Link to="/berita" className="inline-flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-medium hover:underline mb-6">
