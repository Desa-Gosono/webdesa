...
export default function BeritaPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <PageHero 
        title="Berita" 
        description="Jelajahi informasi lengkap mengenai berita di Desa Gosono."
        icon={Leaf}
      />
      <div className="container mx-auto px-4 py-12 relative z-10 flex-grow">
        {/* TODO: Implement Berita content here */}
        <div className="h-96 rounded-2xl border border-gray-200 bg-white/80 p-8 shadow-sm backdrop-blur-md dark:border-gray-800 dark:bg-gray-950/80">
          <h2 className="font-display text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Konten Berita</h2>
