    ...
    return (
      <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-900 pt-20">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <Link to="/kategori/agenda" className="text-sky-600 hover:underline inline-flex items-center gap-2">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10 max-w-4xl">
        <Link to="/kategori/agenda" className="inline-flex items-center gap-2 text-sky-600 hover:text-sky-700 dark:text-sky-400 dark:hover:text-sky-300 font-medium mb-8 transition-colors">
